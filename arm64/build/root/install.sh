...
# call pacman db and package updater script https://github.com/binhex/scripts/blob/master/shell/arch/docker/upd.sh
# Does not work as reflector is not available for arm64
# source upd.sh
# update packages without updating mirrorlist
